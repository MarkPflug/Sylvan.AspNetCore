...
namespace Sylvan.AspNetCore.Mvc.Formatters
{
    public class CsvInputFormatter : TextInputFormatter
    {
        ...
        public CsvInputFormatter() : this(null)
        {
        }
        ...
        )
        {
            ...
            if (schemaSpecHeader.Count == 1)
            {
                ...
                // TODO: I might need to use a special "type" for the cache key here
                // using string worries me a bit.
            ...
            if (opts.Buffer == null)
            {
                ...
                // create a TextReader that will return our rented buffer when disposed.
